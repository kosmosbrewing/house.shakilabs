...
//
// 왜 소스 grep이 아니라 빌드 산출물인가: .vue를 훑으면 주석·속성·문자열까지 세어
// 과대 수집된다(같은 함대의 nutri가 465자/64KB로 부푼 사례). 이 앱은 vite-ssg라
// dist/*.html이 곧 최종 DOM이다 — 거기서 GmarketSans로 그려지는 요소만 센다.
//
