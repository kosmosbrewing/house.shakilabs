...
<template>
  <div class="retro-panel overflow-hidden">
    ...
    >
      <p :class="['text-[11px] font-bold uppercase tracking-[0.14em] sm:text-[13px]', highlight ? 'text-white/80' : 'text-foreground/60']">
        {{ leaderLabel ?? "가장 유리한 마켓" }}
      </p>
      <p :class="['text-[24px] font-bold leading-none sm:text-[32px]', highlight ? 'text-white' : 'text-foreground']">
        {{ leaderValue }}
      </p>
    </div>
