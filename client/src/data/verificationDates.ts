...
export const VERIFICATION_DATES: readonly VerificationDate[] = [
  { topic: "양도소득세", basis: "소득세법 제94~104조·시행령 제159조의4", date: CAPITAL_GAINS_TAX_UPDATED },
  { topic: "생애최초 취득세 감면·디딤돌 한도", basis: "행정안전부 고시·주택도시기금 안내", date: FIRST_HOME_UPDATED },
  { topic: "전세보증금 위험도", basis: "주택도시보증공사 전세보증 심사 기준", date: JEONSE_RISK_DATA_UPDATED },
  { topic: "재산세·종합부동산세", basis: "지방세법·종합부동산세법·공정시장가액비율 고시", date: PROPERTY_TAX_UPDATED },
  { topic: "전월세 전환율", basis: "주택임대차보호법 시행령 제9조", date: JEONSE_WOLSE_RATE_UPDATED },
  { topic: "보증금 지연이자", basis: "민법 제379조·소송촉진 등에 관한 특례법", date: DELAY_INTEREST_DATA_UPDATED },
  { topic: "임대수익률", basis: "총수익률·순수익률·ROE 계산식", date: RENTAL_YIELD_UPDATED },
  { topic: "취득세", basis: "지방세법 제11조·다주택 중과세율", date: ACQUISITION_TAX_UPDATED },
  { topic: "청약 가점", basis: "주택공급에 관한 규칙 별표1", date: HOUSING_SUBSCRIPTION_UPDATED },
  { topic: "중개보수", basis: "서울특별시 주택 중개보수 등에 관한 조례", date: BROKERAGE_DATA_UPDATED },
  { topic: "전세 vs 월세 기회비용", basis: "기회비용 금리 입력 기반 비교식", date: JEONSE_WOLSE_DATA_UPDATED },
] as const;
